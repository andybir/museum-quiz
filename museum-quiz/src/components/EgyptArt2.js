...
class EgyptArt2 extends Component {
    constructor() {
        super()
        this.state = {
            artifact: []
    ...
    async componentDidMount() {
        const response = await axios('https://api.harvardartmuseums.org/object/303606?apikey=c7afc0b0-e325-11e9-9fc2-ed594f20726e')
    ...
    render() {
        return(
            <div className="artifact">
                ...
                <button><Link to='egypt-quiz2'>{'Quiz Time!'}</Link></button>
            </div>
        )
    }
}

export default EgyptArt2